...
function getUserId(req: Request): string { return (req.headers['x-user-id'] as string) || 'anonymous'; }
...
router.put('/:id', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (!vision) { res.status(404).json({ success: false, message: 'Not found' }); return; }
