 ...
 */
function generateAdminUserId(email: string): string {
...
// ===== GET ADMIN PROFILE =====
router.get('/profile/:adminId', async (req: Request, res: Response): Promise<void> => {
  try {
...
router.put('/profile/:adminId', async (req: Request, res: Response): Promise<void> => {
  try {
    const { adminId } = req.params;
...
// ===== CHANGE PASSWORD =====
router.post('/change-password/:adminId', async (req: Request, res: Response): Promise<void> => {
  try {
    const { adminId } = req.params;
    ...
    if (!admin.metadata) admin.metadata = {};
...
// ===== DEACTIVATE ADMIN =====
router.post('/deactivate/:adminId', async (req: Request, res: Response): Promise<void> => {
  try {
    const { adminId } = req.params;
...
router.get('/contact/messages', async (req: Request, res: Response): Promise<void> => {
  try {
...
router.get('/contact/messages/:id', async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
router.put('/contact/messages/:id', async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
router.delete('/contact/messages/:id', async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
