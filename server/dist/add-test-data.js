...
async function addTestData() {
    try {
        ...
        const visionResult = await visionCollection.insertOne(testVision);
        ...
        const goalResult = await goalCollection.insertOne(testGoal);
...
addTestData();
//# sourceMappingURL=add-test-data.js.map