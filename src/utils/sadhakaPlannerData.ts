...
const getAPIUrl = () => {
  ...
  if (isDev) {
    ...
    // Production - use same origin (swaryoga.com routes to Vercel which serves both frontend and API)
    return '/api'; // Relative path - Vercel will route to correct backend
  }
};
