      ...
      <section className="relative py-16 sm:py-20 px-4 sm:px-6">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <p className="text-lg sm:text-xl text-gray-200 leading-relaxed">
            Have questions about our workshops or life planning tools? We'd love to hear from you.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">globalswaryoga@gmail.com</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                {/* WhatsApp Number */}
                <div>
                  <label htmlFor="whatsapp" className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">
                    WhatsApp Number *
                  </label>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white py-3 sm:py-4 px-6 rounded-lg font-semibold hover:from-green-700 hover:to-green-800 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                  {isSubmitting ? (
                    <>
